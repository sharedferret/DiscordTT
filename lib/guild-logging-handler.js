...
const handleGuildMemberAdd = (embed, data) => {
  ...
  embed.addField('User Creation Date', userJoinDate.format('dddd, MMMM Do YYYY, h:mm:ss a'));
...
const handleGuildMemberRemove = (embed, data) => {
  ...
  embed.addField('Guild Join Date', guildJoinDate.format('dddd, MMMM Do YYYY, h:mm:ss a'));
