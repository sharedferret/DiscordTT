...
var addDj = function(bot, message) {
  ...
  if (_.findIndex(this.state.djs, function(i) { return i.id == message.author.id; }) > -1 ||
...
var removeDj = function(bot, message) {
  ...
  if (this.state.djs[this.state.currentDj] && this.state.djs[this.state.currentDj].id == message.author.id) {
